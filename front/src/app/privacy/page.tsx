...
const PrivacyPolicy = () => {
  return (
    <div className="bg-primary text-white">
      <Head>
        <title>プライバシーポリシー | Dmission</title>
        <meta name="description" content="Dmissionのプライバシーポリシーです。" />
      </Head>
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">プライバシーポリシー</h1>
        <p>
          Dmission（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
